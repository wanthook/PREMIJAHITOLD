...
class index_jahit 
{
    ...
    function __construct() 
    {
        ...
        $this->tblName = "jht_index_jahit";
        $this->tblNameDet = "jht_index_jahit_detail";
    ...
    {
        $sql = "select c.hanging_id,
                        c1.hanging_desc,
                        c.jenis_id,
                        c2.jenis_desc,
                        c.transaksi_hasil_jahit_jam_kerja,
                        a.ukuran_detail_id,
                        a1.ukuran_id,
                        a1.ukuran_desc,
                        a.jumlah
               from jht_transaksi_hasil_jahit_detail_ukuran a
                        left join jht_master_ukuran_view a1 on a.ukuran_detail_id = a1.ukuran_detail_id,
                    jht_transaksi_hasil_jahit_detail b,
                    jht_transaksi_hasil_jahit c
                        left join jht_master_hanging c1 on c.hanging_id = c1.hanging_id
                        left join jht_master_jenis_jahit c2 on c.jenis_id = c2.jenis_id
               where a.transaksi_hasil_jahit_detail_id = b.transaksi_hasil_jahit_detail_id
                        and b.transaksi_hasil_jahit_id = c.transaksi_hasil_jahit_id";
