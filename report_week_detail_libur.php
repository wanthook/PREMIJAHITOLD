...
$con = $conect->openDb();
?>
<script src="./js/app/reportweekdetaillibur.js"></script>
<style>
    .jtable-dialog-form
    {
        min-width: 400px;
...
<div class="box">
    ...
    <div class="filtering">
        <form>
            <table>
			<div class="box-head">
				<h2>Report Detail Periode Libur</h2>
			</div>
                <tr>
                ...
                <tr>
                    <td width="150px">&nbsp;</td>
                    <td>
                        <button id="cmdReportWeekLibur">Download</button>
                    </td>
                </tr>
            </table>
