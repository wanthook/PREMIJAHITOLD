...
var strDivTable = "itemTableHasilJahitLibur";
var strControler = "con_hasil_jahit_libur";

$(document).ready(function(){
    
    if($('#'+strDivTable).jtable())
        $('#'+strDivTable).jtable('destroy');
    ...
    $('#'+strDivTable).jtable(
    {
        title: 'Transaksi Hasil Jahit Libur',
        ...
        fields: 
        {
            ...
            {
                title: 'Jenis Jahit',
                options: './controller/'+strControler+'.php?action=jen',
                inputClass: 'validate[required]'
            },
//            IndexJamKerja: 
//            {
//                title: 'Jam Kerja',
//                options: './controller/'+strControler+'.php?action=jamker',
//                inputClass: 'validate[required]'
//            },
            HangingId: 
            {
                title: 'Hanging',
                options: './controller/'+strControler+'.php?action=hang',
                inputClass: 'validate[required]'
            },
            LastEdit: 
            {
                    ...
                    $imga.click(function () 
                    {
                        $('#'+strDivTable).jtable('openChildTable',
                                $imga.closest('tr'), //Parent row
                                {
                                    ...
                                    actions: 
                                    {
                                        listAction: './controller/'+strControler+'.php?action=viewDet&HasilJahitId='+item.record.HasilJahitId,
                                        createAction: './controller/'+strControler+'.php?action=createDet&HasilJahitId='+item.record.HasilJahitId+'&HangingId='+item.record.HangingId,
                                                ...
                                                $imgb.click(function () 
                                                {
                                                    $('#'+strDivTable).jtable('openChildTable',
                                                            $imgb.closest('tr'), //Parent row
                                                            {
                                                                ...
                                                                actions: 
                                                                {
                                                                    listAction: './controller/'+strControler+'.php?action=viewUkuranDet&HasilJahitDetId='+item.record.HasilJahitDetId,
                                                                    createAction: './controller/'+strControler+'.php?action=createUkuranDet',
                                                                    updateAction: './controller/'+strControler+'.php?action=updateUkuranDet',
                                                                    deleteAction: './controller/'+strControler+'.php?action=deleteUkuranDet&HasilJahitDetId='+item.record.HasilJahitDetId
                                                                },
                                                                fields: 
                                                                {
                                                                    HasilUkuranDetId: 
                                                                    ...
                                                                    TimeId: 
                                                                    {
                                                                        title: 'Jam',
                                                                        edit: false,
                                                                        options: './controller/'+strControler+'.php?action=time',
                                                                        inputClass: 'validate[required]'
                                                                    }, 
                                                                    ...
                                                                    {
                                                                        title: 'Ukuran',
                                                                        options: './controller/'+strControler+'.php?action=sizDet',
                                                                        inputClass: 'validate[required]'
                                                                    }, 
